        ...
        <div className="rounded-xl border border-slate-200 bg-white shadow-sm overflow-hidden mb-8 animate-in slide-in-from-bottom-4 fade-in duration-700">
            <div className="border-b border-slate-200 bg-slate-50 px-6 md:px-8 py-5 flex items-start sm:items-center justify-between flex-col sm:flex-row gap-4">
                <div>
                    ...
                    <p className="text-sm text-slate-500 mt-1">For: {questionRef ?? 'Submitted answer'}</p>
                </div>
                ...
                <div className="flex items-center gap-6 mb-8 p-6 bg-slate-50 rounded-xl border border-slate-100">
                    ...
                    <div>
                        <div className="flex items-center gap-2 mb-1">
                            <span className="text-xl font-bold text-slate-900">Grade: {grade}</span>
                        </div>
                        <p className="text-sm text-slate-600 font-medium">AI-generated rubric feedback for your submitted answer.</p>
                    </div>
                </div>
                    ...
                    <div>
                        ...
                        <ul className="space-y-3">
                            {result.strengths.length === 0 ? (
                                <li className="text-sm text-slate-500">No strengths identified yet.</li>
                            ) : (
                    ...
                    <div>
                        ...
                        <ul className="space-y-3">
                            {result.improvements.length === 0 ? (
                                <li className="text-sm text-slate-500">No improvements suggested.</li>
                            ) : (
